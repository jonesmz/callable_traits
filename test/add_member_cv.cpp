...
int main() {

    {
        ...
        CT_ASSERT(std::is_same_v<cv,    TRAIT(add_member_cv, f)>);
        CT_ASSERT(std::is_same_v<cv,    TRAIT(add_member_cv, c)>);
        CT_ASSERT(std::is_same_v<cvl,   TRAIT(add_member_cv, l)>);
        CT_ASSERT(std::is_same_v<cvl,   TRAIT(add_member_cv, cl)>);
        CT_ASSERT(std::is_same_v<cvr,   TRAIT(add_member_cv, r)>);
        CT_ASSERT(std::is_same_v<cvr,   TRAIT(add_member_cv, cr)>);
        CT_ASSERT(std::is_same_v<cv,   TRAIT(add_member_cv, v)>);
        CT_ASSERT(std::is_same_v<cv,   TRAIT(add_member_cv, cv)>);
        CT_ASSERT(std::is_same_v<cvl,  TRAIT(add_member_cv, vl)>);
        CT_ASSERT(std::is_same_v<cvl,  TRAIT(add_member_cv, cvl)>);
        CT_ASSERT(std::is_same_v<cvr,  TRAIT(add_member_cv, vr)>);
        CT_ASSERT(std::is_same_v<cvr,  TRAIT(add_member_cv, cvr)>);
    }
