...
int main() {

    {
        ...
        static_assert(std::is_same_v<cv,    TRAIT(add_member_cv, f)>);
        static_assert(std::is_same_v<cv,    TRAIT(add_member_cv, c)>);
        static_assert(std::is_same_v<cvl,   TRAIT(add_member_cv, l)>);
        static_assert(std::is_same_v<cvl,   TRAIT(add_member_cv, cl)>);
        static_assert(std::is_same_v<cvr,   TRAIT(add_member_cv, r)>);
        static_assert(std::is_same_v<cvr,   TRAIT(add_member_cv, cr)>);
        static_assert(std::is_same_v<cv,   TRAIT(add_member_cv, v)>);
        static_assert(std::is_same_v<cv,   TRAIT(add_member_cv, cv)>);
        static_assert(std::is_same_v<cvl,  TRAIT(add_member_cv, vl)>);
        static_assert(std::is_same_v<cvl,  TRAIT(add_member_cv, cvl)>);
        static_assert(std::is_same_v<cvr,  TRAIT(add_member_cv, vr)>);
        static_assert(std::is_same_v<cvr,  TRAIT(add_member_cv, cvr)>);
    }
