...
void assert_lvalue_qualified() {
    ...
    static_assert( is_lvalue_reference_member<T>());
}
...
int main() {
...

    {
        ...
        static_assert(! is_lvalue_reference_member<f>());
        static_assert( is_lvalue_reference_member<l>());
        static_assert(! is_lvalue_reference_member<r>());
        static_assert(! is_lvalue_reference_member<c>());
        static_assert( is_lvalue_reference_member<cl>());
        static_assert(! is_lvalue_reference_member<cr>());
        static_assert(! is_lvalue_reference_member<v>());
        static_assert( is_lvalue_reference_member<vl>());
        static_assert(! is_lvalue_reference_member<vr>());
        static_assert(! is_lvalue_reference_member<cv>());
        static_assert( is_lvalue_reference_member<cvl>());
        static_assert(! is_lvalue_reference_member<cvr>());
    }
