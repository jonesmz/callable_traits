...
int main() {
    
    {
        ...
        static_assert(std::is_same_v<f,   TRAIT(remove_member_volatile, f)>);
        static_assert(std::is_same_v<l,   TRAIT(remove_member_volatile, vl)>);
        static_assert(std::is_same_v<l,   TRAIT(remove_member_volatile, l)>);
        static_assert(std::is_same_v<f,   TRAIT(remove_member_volatile, v)>);
        static_assert(std::is_same_v<r,   TRAIT(remove_member_volatile, r)>);
        static_assert(std::is_same_v<r,   TRAIT(remove_member_volatile, vr)>);
        static_assert(std::is_same_v<c,   TRAIT(remove_member_volatile, c)>);
        static_assert(std::is_same_v<c,   TRAIT(remove_member_volatile, cv)>);
        static_assert(std::is_same_v<cl,  TRAIT(remove_member_volatile, cl)>);
        static_assert(std::is_same_v<cl,  TRAIT(remove_member_volatile, cvl)>);
        static_assert(std::is_same_v<cr,  TRAIT(remove_member_volatile, cr)>);
        static_assert(std::is_same_v<cr,  TRAIT(remove_member_volatile, cvr)>);
    }
