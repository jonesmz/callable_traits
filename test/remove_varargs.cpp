...
int main() {

    {
        ...
        static_assert(std::is_same_v<f,    TRAIT(remove_varargs, va_f)>);
        static_assert(std::is_same_v<l,    TRAIT(remove_varargs, va_l)>);
        static_assert(std::is_same_v<r,    TRAIT(remove_varargs, va_r)>);
        static_assert(std::is_same_v<c,    TRAIT(remove_varargs, va_c)>);
        static_assert(std::is_same_v<cl,   TRAIT(remove_varargs, va_cl)>);
        static_assert(std::is_same_v<cr,   TRAIT(remove_varargs, va_cr)>);
        static_assert(std::is_same_v<v,    TRAIT(remove_varargs, va_v)>);
        static_assert(std::is_same_v<vl,   TRAIT(remove_varargs, va_vl)>);
        static_assert(std::is_same_v<vr,   TRAIT(remove_varargs, va_vr)>);
        static_assert(std::is_same_v<cv,   TRAIT(remove_varargs, va_cv)>);
        static_assert(std::is_same_v<cvl,  TRAIT(remove_varargs, va_cvl)>);
        static_assert(std::is_same_v<cvr,  TRAIT(remove_varargs, va_cvr)>);

        static_assert(std::is_same_v<f,    TRAIT(remove_varargs, f)>);
        static_assert(std::is_same_v<l,    TRAIT(remove_varargs, l)>);
        static_assert(std::is_same_v<r,    TRAIT(remove_varargs, r)>);
        static_assert(std::is_same_v<c,    TRAIT(remove_varargs, c)>);
        static_assert(std::is_same_v<cl,   TRAIT(remove_varargs, cl)>);
        static_assert(std::is_same_v<cr,   TRAIT(remove_varargs, cr)>);
        static_assert(std::is_same_v<v,    TRAIT(remove_varargs, v)>);
        static_assert(std::is_same_v<vl,   TRAIT(remove_varargs, vl)>);
        static_assert(std::is_same_v<vr,   TRAIT(remove_varargs, vr)>);
        static_assert(std::is_same_v<cv,   TRAIT(remove_varargs, cv)>);
        static_assert(std::is_same_v<cvl,  TRAIT(remove_varargs, cvl)>);
        static_assert(std::is_same_v<cvr,  TRAIT(remove_varargs, cvr)>);
    }
