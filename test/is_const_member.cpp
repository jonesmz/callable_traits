...
void assert_const_qualified() {
    static_assert( is_const_member<T>());
}
...
int main() {
...

    {
        ...
        static_assert(! is_const_member<f>());
        static_assert(! is_const_member<l>());
        static_assert(! is_const_member<r>());
        static_assert( is_const_member<c>());
        static_assert( is_const_member<cl>());
        static_assert( is_const_member<cr>());
        static_assert(! is_const_member<v>());
        static_assert(! is_const_member<vl>());
        static_assert(! is_const_member<vr>());
        static_assert( is_const_member<cv>());
        static_assert( is_const_member<cvl>());
        static_assert( is_const_member<cvr>());
    }
